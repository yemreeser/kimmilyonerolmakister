...
namespace kimmilyonerolmakister
{
    public partial class Form1 : Form
    {
        ...
        private void JokerSeyirci()
        {
            ...
            int correctWeight = _rnd.Next(40, 70);
            int otherWeights = (100 - correctWeight);
            
            // Simulating audience votes
            MessageBox.Show($"Seyirci Oylaması:\nA: %{_rnd.Next(25)}\nB: %{_rnd.Next(25)}\nC: %{_rnd.Next(25)}\nD: %{_rnd.Next(25)}\n(En yüksek ihtimal doğru cevaptır)");
            // For simplicity, just showing a message. A real chart would be better but this is fine for basic.
        }
